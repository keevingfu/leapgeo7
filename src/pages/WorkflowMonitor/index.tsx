...
const mockExecutions: WorkflowExecution[] = [
    ...
    steps: [
      {
        ...
        completedAt: new Date('2025-01-07T10:05:00'),
        duration: 300,
        error: null,
      ...
      },
      {
        ...
        status: 'completed',
        startedAt: new Date('2025-01-07T10:05:00'),
        completedAt: new Date('2025-01-07T10:08:00'),
        duration: 180,
        error: null,
      ...
      },
      {
        ...
        status: 'running',
        startedAt: new Date('2025-01-07T10:08:00'),
        completedAt: null,
        duration: null,
        error: null,
  ...
  },
  {
    ...
    steps: stepConfigs.map((config, index) => ({
      ...
      startedAt: new Date(`2025-01-06T09:${String(index * 10).padStart(2, '0')}:00`),
      completedAt: new Date(`2025-01-06T09:${String((index + 1) * 10).padStart(2, '0')}:00`),
      duration: config.estimatedDuration,
      error: null,
      metadata: {},
    })),
    startedAt: new Date('2025-01-06T09:00:00'),
    completedAt: new Date('2025-01-06T10:10:00'),
    totalDuration: 4200,
    triggeredBy: 'admin@sweetnight.com',
  ...
  },
  {
    ...
    steps: stepConfigs.map((config, index) => ({
      ...
      startedAt: index <= 4 ? new Date(`2025-01-05T08:${String(index * 10).padStart(2, '0')}:00`) : null,
      completedAt: index < 4 ? new Date(`2025-01-05T08:${String((index + 1) * 10).padStart(2, '0')}:00`) : null,
      duration: index < 4 ? config.estimatedDuration : null,
      error: index === 4 ? 'Template rendering error: Missing variable productName' : null,
      metadata: {},
    })),
    startedAt: new Date('2025-01-05T08:00:00'),
    completedAt: new Date('2025-01-05T08:50:00'),
    totalDuration: 3000,
